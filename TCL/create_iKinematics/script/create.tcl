...
#
# create.tcl: Tcl script for re-creating project 'arty7z10_ikinematics_v2_2'
#
# Generated by Vivado on Thu Mar 28 21:47:00 -0300 2019
...
#
#    "C:/Users/Roy/Documents/Vivado/robotics/arty7z10_ikinematics_v2_2/arty7z10_ikinematics_v2_2.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "C:/Users/Roy/Documents/Vivado/robotics/arty7z10_ikinematics_v2_2/arty7z10_ikinematics_v2_2.srcs/constrs_1/new/constraints.xdc"
#
...
set origin_ip_repo_dir "$origin_dir\\ip_repo"
...
set _xil_proj_name_ "arty7z10_ikinematics_v2_2"
...
set_property -name "board_part" -value "digilentinc.com:arty-z7-10:part0:1.0" -objects $obj
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "dsa.accelerator_binary_content" -value "bitstream" -objects $obj
set_property -name "dsa.accelerator_binary_format" -value "xclbin2" -objects $obj
set_property -name "dsa.board_id" -value "arty-z7-10" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_ip_repo_dir/axi_ikinematics_1.2"]" $obj
...
set files [list \
 [file normalize "$origin_sources_dir/design_1_wrapper.v" ]\
]
...
set file "[file normalize "$origin_constraints_dir/constraints.xdc"]"
...
proc cr_bd_design_1 { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:user:axi_ikinematics:1.2\
  ...
  # Create ports
  set pwm_out [ create_bd_port -dir O -from 17 -to 0 -type data pwm_out ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_ikinematics_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net axi_ikinematics_0_s00_pwm_out [get_bd_ports pwm_out] [get_bd_pins axi_ikinematics_0/s00_pwm_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_ikinematics_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_ikinematics_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_ikinematics_0/S00_AXI/S00_AXI_reg] SEG_axi_ikinematics_0_S00_AXI_reg
...
preplace portBus pwm_out -pg 1 -y 140 -defaultsOSRD
preplace inst axi_ikinematics_0 -pg 1 -lvl 3 -y 140 -defaultsOSRD
...
preplace netloc processing_system7_0_DDR 1 1 3 NJ 260 730J 250 NJ
preplace netloc axi_ikinematics_0_s00_pwm_out 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 420 240 730J
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 10 430 250 720J
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N
levelinfo -pg 1 0 220 580 880 1050 -top 0 -bot 420
"
}
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z010clg400-1 -flow {Vivado Implementation 2018} -strategy "Performance_ExtraTimingOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
